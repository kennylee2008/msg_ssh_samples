...
<div>
    	<table>
    		<tr>
    			...
    			<td>
    				<s:property value="#m.thread.title"/>
    			</td>
    		</tr>
    		<tr>
    			<td>
    			...
    			<td>
    				<s:property value="#m.thread.content"/>
    			</td>
    		</tr>
    		<tr>
    			<td>
    			...
    			<td>
    				<s:property value="#m.thread.senderName"/>
    			</td>
    		</tr>    		
    		<tr>
    			<td>
    			...
    			<td>
    				<s:iterator value="#m.thread.receiverNames">
    		...
    		<tr>
    			...
    			<td>
    				<s:date name="#m.thread.sendTime" format="yyyy-MM-dd HH:mm:ss"/>
    			</td>
    		</tr>
    	</table>
</div>
